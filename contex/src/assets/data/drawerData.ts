...
export const DATA1: RenderDrawerItemProps[]=[
...
export const DATA2: RenderDrawerItemProps[]= [
...
export const DATA3: RenderDrawerItemProps[] = [
...
export const DATA4: RenderDrawerItemProps[] = [
